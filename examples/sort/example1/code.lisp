...
(CONSTRUCTION  "Unix" "03-JUN,1992 18:39" 
              ("Edit:     Axioms and Theorems edited: 29-MAY,1992 14:13 "
               ))
...
(THEOREMS.INFIX ((EX X |:| D (LIES (LION X YESTER (X)) AND LIES (UNICORN X YESTER (X))))))
...
(THEOREMS.PREFIX ((EX 72 (AND (+ 56 (55 72 (46 72)) NIL) (+ 56 (65 72 (46 72)) NIL)))))
...
(THEOREMS (SPLITPART.IDENTIFIER 1)
          (START.TIME 198410000)
          (PARTIAL   (CLAUSE 168 T46 THEOREM ((72 . 36))
                           ((- 56 (55 72 (46 72))) (- 56 (65 72 (46 72))) )))
...
(CLAUSE 148 A39 AXIOM ((69 . 28)(68 . 28)) ((- 56 (65 68 69)) )) )
          (END.TIME 202670000)
          (FINAL 75 76 77 78 79 80 81 82 88 96 108 110 128 130 132 134 136 138 140 142 145 148)
          (SYMBOLS 
                   (LET (NEW.ADDRESS)
          (LIST (CONS   56 (DT-PREDICATE.CREATE "LIES" '(ANY ANY ANY)))
                           (PROG1 (CONS    4 (SETQ NEW.ADDRESS (DT-PREDICATE.CREATE "E" '(ANY ANY))))
...
(SPLITPARTS "Unix" "03-JUN,1992 18:39" NIL)
...
(REFUTATION (START.TIME 203070000)
...
(CLAUSE 145 A38 AXIOM ((60 . 20)(59 . 20)) ((- 56 (55 59 60)) ))
(CLAUSE 148 A39 AXIOM ((69 . 28)(68 . 28)) ((- 56 (65 68 69)) )) )
            (OPERATION (CLAUSE 286 R1 (96 88) () ())
                       (RESOLUTION 88 1 96 1 NIL (26 22) 286))
            (END.TIME 204320000)
            (SYMBOLS 
                     (LET (NEW.ADDRESS)
          (LIST (CONS   56 (DT-PREDICATE.CREATE "LIES" '(ANY ANY ANY)))
