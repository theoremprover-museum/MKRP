...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((EX X A (X) OR B (X)) (ALL X B (X) IMPL C (X)) (ALL X (A (X) OR D (X)) IMPL C (X)))) (QUOTE ((EX 3 (OR (+ 4 (3) NIL) (+ 5 (3) NIL))) (ALL 6 (IMPL (+ 5 (6) NIL) (+ 7 (6) NIL))) (ALL 8 (IMPL (OR (+ 4 (8) NIL) (+ 9 (8) NIL)) (+ 7 (8) NIL))))) (QUOTE ((EX X C (X)))) (QUOTE ((EX 10 (+ 7 (10) NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 26-FEB,1991 10:01 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(19879 19894 19899 19914 19919 19934 19949 19954 19969 19984 19999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          VARIABLE 15 "A" NIL NIL (ANY) NIL NIL ((- 4 (POSITIVE))) ((+ 4 (NEGATIVE)))
          ((+ 4 (NIL))) ((- 4 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 15 "B" NIL NIL (ANY)
          ...
          "C" NIL NIL (ANY) NIL NIL ((- 7 (POSITIVE))) ((+ 7 (NEGATIVE))) ((+ 7 (NIL)))
          ((- 7 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 5 ANY NIL
          (ST*DATA NIL DT*ST-KIND SYS-VAR) VARIABLE 15 "D" NIL NIL (ANY) NIL NIL
