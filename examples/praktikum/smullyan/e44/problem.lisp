...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS FOR PROBLEM 44 %.) (* THE ISLAND OF BAHAVA) (* A KNIGHT COULD MARRY ONLY A KNAVE.) (* A NORMAL COULD ONLY MARRY A NORMAL.) (* A KNAVE COULD ONLY MARRY A KNAVE.) (*) (* WE FIRST CONSIDER A MARRIED COUPLE,MRS. AND MR.ABNORMAL.) (* MR.ABNORMAL SAYS : MY WIFE IS NOT NORMAL.) (* MRS.ABNORMAL SAYS : MY HUSBAND IS NOT NORMAL.) (* WHAT ARE MRS. AND MR.ABNORMAL?) (*) (* MARRIED (X Y) MEANS X AND Y ARE MARRIED.) (* NNORMAL2 (X Y) MEANS X SAYS : Y IS NOT NORMAL.) (*) (ALL X KNIGHT (X) EQV NOT KNAVE (X) AND NOT NORMAL (X)) (ALL X KNAVE (X) EQV NOT KNIGHT (X) AND NOT NORMAL (X)) (ALL X NORMAL (X) EQV NOT KNIGHT (X) AND NOT KNAVE (X)) (ALL X,Y MARRIED (X Y) IMPL KNIGHT (X) AND KNAVE (Y) OR KNAVE (X) AND KNIGHT (Y) OR NORMAL (X) AND NORMAL (Y)) (ALL X,Y NNORMAL2 (X Y) AND KNAVE (X) IMPL NORMAL (X)) (ALL X,Y NNORMAL2 (X Y) AND KNIGHT (X) IMPL NOT NORMAL (X)) (MARRIED (MRSABNORMAL MRABNORMAL)) (NNORMAL2 (MRABNORMAL MRSABNORMAL)) (NNORMAL2 (MRSABNORMAL MRABNORMAL)))) (QUOTE (COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT COMMENT (ALL 2 (EQV (+ 3 (2) (KIND (EQV T 160))) (AND (NOT (+ 4 (2) (KIND (EQV NIL 160)))) (NOT (+ 5 (2) (KIND (EQV NIL 160))))))) (ALL 6 (EQV (+ 4 (6) (KIND (EQV T 170))) (AND (NOT (+ 3 (6) (KIND (EQV NIL 170)))) (NOT (+ 5 (6) (KIND (EQV NIL 170))))))) (ALL 7 (EQV (+ 5 (7) (KIND (EQV T 180))) (AND (NOT (+ 3 (7) (KIND (EQV NIL 180)))) (NOT (+ 4 (7) (KIND (EQV NIL 180))))))) (ALL 9 (ALL 8 (IMPL (+ 10 (8 9) NIL) (OR (AND (+ 3 (8) NIL) (+ 4 (9) NIL)) (OR (AND (+ 4 (8) NIL) (+ 3 (9) NIL)) (AND (+ 5 (8) NIL) (+ 5 (9) NIL))))))) (ALL 12 (ALL 11 (IMPL (AND (+ 13 (11 12) NIL) (+ 4 (11) NIL)) (+ 5 (11) NIL)))) (ALL 15 (ALL 14 (IMPL (AND (+ 13 (14 15) NIL) (+ 3 (14) NIL)) (NOT (+ 5 (14) NIL))))) (+ 10 (16 17) NIL) (+ 13 (17 16) NIL) (+ 13 (16 17) NIL))) (QUOTE ((NORMAL (MRABNORMAL) AND NORMAL (MRSABNORMAL)))) (QUOTE ((AND (+ 5 (17) NIL) (+ 5 (16) NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 15-DEC,1989 01:26 ")) (PROGN(PROGN (DT-RESET))
...
(PROG ((ADDRLIST
       ...
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          (ST*DATA NIL DT*ST-KIND SYS-VAR) VARIABLE 5 ANY NIL (ST*DATA NIL DT*ST-KIND SYS-VAR)
          VARIABLE 15 "NNORMAL2" NIL NIL (ANY ANY) NIL NIL ((- 13 (POSITIVE)))
