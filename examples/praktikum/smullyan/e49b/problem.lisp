...
(PROG ((ADDRLIST
      ...
      (COND ((> MEM*SIZE 36000)
            ...
            (T (UNLESS (= MEM*SIZE 36000)
                 (MEM-INITIALIZE 36000))
               (SETQ COUNTER1 71)
      ...
      (SETQ MEM*NEXT.RADR (IF (> MEM*SIZE 36000) (+ 35495 INCREMENT) 35495))
