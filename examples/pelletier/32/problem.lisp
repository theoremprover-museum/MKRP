...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (ALL X F (X) AND (G (X) OR H (X)) IMPL I (X)) (ALL X I (X) AND H (X) IMPL J (X)) (ALL X K (X) IMPL H (X)))) (QUOTE (COMMENT (ALL 2 (IMPL (AND (+ 3 (2) NIL) (OR (+ 4 (2) NIL) (+ 5 (2) NIL))) (+ 6 (2) NIL))) (ALL 7 (IMPL (AND (+ 6 (7) NIL) (+ 5 (7) NIL)) (+ 8 (7) NIL))) (ALL 9 (IMPL (+ 10 (9) NIL) (+ 5 (9) NIL))))) (QUOTE ((* THEOREMS *) (ALL X F (X) AND K (X) IMPL J (X)))) (QUOTE (COMMENT (ALL 11 (IMPL (AND (+ 3 (11) NIL) (+ 10 (11) NIL)) (+ 8 (11) NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 23:12 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9864 9879 9884 9899 9904 9919 9934 9949 9964 9969 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          (DT*ST-KIND NIL) PREDICATE 15 "H" NIL NIL (ANY) NIL NIL ((- 5 (POSITIVE)))
          ((+ 5 (NEGATIVE))) ((+ 5 (NIL))) ((- 5 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 15
          "I" NIL NIL (ANY) NIL NIL ((- 6 (POSITIVE))) ((+ 6 (NEGATIVE))) ((+ 6 (NIL)))
          ...
          "K" NIL NIL (ANY) NIL NIL ((- 10 (POSITIVE))) ((+ 10 (NEGATIVE))) ((+ 10 (NIL)))
