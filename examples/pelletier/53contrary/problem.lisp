...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (EX X,Y NOT X = Y AND (ALL Z Z = X OR Z = Y)))) (QUOTE (COMMENT (EX 4 (EX 3 (AND (NOT (+ 2 (3 4) NIL)) (ALL 5 (OR (+ 2 (5 3) NIL) (+ 2 (5 4) NIL)))))))) (QUOTE ((* THEOREMS *) (NOT ((EX Z (ALL X ((EX W (ALL Y (P (X Y) EQV Y = W))) EQV X = Z))) EQV (EX Z (ALL X ((EX W (ALL Y (P (Y X) EQV Y = W))) EQV X = Z))))))) (QUOTE (COMMENT (NOT (EQV (EX 6 (ALL 7 (EQV (EX 8 (ALL 9 (EQV (+ 10 (7 9) (KIND (EQV T 30 EQV T 31 EQV T 34))) (+ 2 (9 8) (KIND (EQV NIL 30 EQV T 31 EQV T 34)))))) (+ 2 (7 6) (KIND (EQV NIL 31 EQV T 34)))))) (EX 11 (ALL 12 (EQV (EX 13 (ALL 14 (EQV (+ 10 (14 12) (KIND (EQV T 32 EQV T 33 EQV NIL 34))) (+ 2 (14 13) (KIND (EQV NIL 32 EQV T 33 EQV NIL 34)))))) (+ 2 (12 11) (KIND (EQV NIL 33 EQV NIL 34)))))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 14-AUG,1990 00:44 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9889 9894 9899 9904 9919 9924 9929 9934 9939 9944 9949 9954 9969 9984 9999))
       (DATALIST
