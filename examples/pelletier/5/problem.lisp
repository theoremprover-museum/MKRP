...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) (((P OR Q) IMPL (P OR R)) IMPL (P OR (Q IMPL R))))) (QUOTE (COMMENT (IMPL (IMPL (OR (+ 2 NIL NIL) (+ 3 NIL NIL)) (OR (+ 2 NIL NIL) (+ 4 NIL NIL))) (OR (+ 2 NIL NIL) (IMPL (+ 3 NIL NIL) (+ 4 NIL NIL)))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 21:19 ")) (PROGN(PROGN (DT-RESET))
