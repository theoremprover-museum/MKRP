...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) (EX X,Y P (X Y) IMPL (ALL X,Y P (X Y))))) (QUOTE (COMMENT (EX 3 (EX 2 (IMPL (+ 4 (2 3) NIL) (ALL 6 (ALL 5 (+ 4 (5 6) NIL)))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 01-NOV,1989 01:21 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(159939 159944 159959 159964 159969 159984 159999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ((+ 0 (NIL))) ((- 0 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 15 "FALSE" NIL NIL
          NIL (DEFINED) NIL ((- 1 (POSITIVE))) ((+ 1 (NEGATIVE))) ((+ 1 (NIL))) ((- 1 (NIL)))
          NIL NIL (DT*ST-KIND NIL) PREDICATE 5 ANY NIL (ST*DATA NIL DT*ST-KIND SYS-VAR)
          VARIABLE 5 ANY NIL (ST*DATA NIL DT*ST-KIND SYS-VAR) VARIABLE 15 "P" NIL NIL (ANY ANY)
      ...
      (SETQ MEM*NEXT.RADR (IF (> MEM*SIZE 160000) (+ 159934 INCREMENT) 159934))
