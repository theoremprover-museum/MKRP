...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) (((P IMPL Q) IMPL P) IMPL P))) (QUOTE (COMMENT (IMPL (IMPL (IMPL (+ 2 NIL NIL) (+ 3 NIL NIL)) (+ 2 NIL NIL)) (+ 2 NIL NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 21:22 ")) (PROGN(PROGN (DT-RESET))
