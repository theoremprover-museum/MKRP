...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (ALL X F (X) IMPL (EX Y G (Y) AND H (X Y)) AND (EX Y G (Y) AND NOT H (X Y))) (EX X J (X) AND (ALL Y G (Y) IMPL H (X Y))))) (QUOTE (COMMENT (ALL 2 (IMPL (+ 3 (2) NIL) (AND (EX 4 (AND (+ 5 (4) NIL) (+ 6 (2 4) NIL))) (EX 7 (AND (+ 5 (7) NIL) (NOT (+ 6 (2 7) NIL))))))) (EX 8 (AND (+ 9 (8) NIL) (ALL 10 (IMPL (+ 5 (10) NIL) (+ 6 (8 10) NIL))))))) (QUOTE ((* THEOREMS *) (EX X J (X) AND NOT F (X)))) (QUOTE (COMMENT (EX 11 (AND (+ 9 (11) NIL) (NOT (+ 3 (11) NIL)))))) (QUOTE ("Edit:     Axioms and Theorems edited: 01-NOV,1989 21:24 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(29884 29889 29904 29909 29914 29929 29944 29949 29964 29969 29984 29999))
       (DATALIST
