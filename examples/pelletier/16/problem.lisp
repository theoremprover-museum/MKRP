...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) ((P IMPL Q) OR (Q IMPL P)))) (QUOTE (COMMENT (OR (IMPL (+ 2 NIL NIL) (+ 3 NIL NIL)) (IMPL (+ 3 NIL NIL) (+ 2 NIL NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 22:22 ")) (PROGN(PROGN (DT-RESET))
