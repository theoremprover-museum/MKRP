...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) ((EX Y (ALL X F (X Y) EQV NOT F (X X))) IMPL NOT (ALL X (EX Y (ALL Z F (X Y) EQV NOT F (Z X))))))) (QUOTE (COMMENT (IMPL (EX 2 (ALL 3 (EQV (+ 4 (3 2) (KIND (EQV T 30))) (NOT (+ 4 (3 3) (KIND (EQV NIL 30))))))) (NOT (ALL 5 (EX 6 (ALL 7 (EQV (+ 4 (5 6) (KIND (EQV T 31))) (NOT (+ 4 (7 5) (KIND (EQV NIL 31)))))))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 01-NOV,1989 21:18 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(29934 29939 29944 29959 29964 29969 29984 29999))
       (DATALIST
