...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) (ALL X P (X F (X)) EQV (EX Y (ALL Z P (Z Y) IMPL P (Z F (X))) AND P (X Y))))) (QUOTE (COMMENT (ALL 2 (EQV (+ 4 (2 (3 2)) (KIND (EQV T 30))) (EX 5 (AND (ALL 6 (IMPL (+ 4 (6 5) (KIND (EQV NIL 30))) (+ 4 (6 (3 2)) (KIND (EQV NIL 30))))) (+ 4 (2 5) (KIND (EQV NIL 30))))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 02-NOV,1989 20:15 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(159930 159935 159950 159964 159969 159984 159999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          "P" NIL NIL (ANY ANY) NIL NIL ((- 4 (POSITIVE))) ((+ 4 (NEGATIVE))) ((+ 4 (NIL)))
