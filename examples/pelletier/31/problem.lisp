...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (NOT (EX X F (X) AND (G (X) OR H (X)))) (EX X I (X) AND F (X)) (ALL X NOT H (X) IMPL J (X)))) (QUOTE (COMMENT (NOT (EX 2 (AND (+ 3 (2) NIL) (OR (+ 4 (2) NIL) (+ 5 (2) NIL))))) (EX 6 (AND (+ 7 (6) NIL) (+ 3 (6) NIL))) (ALL 8 (IMPL (NOT (+ 5 (8) NIL)) (+ 9 (8) NIL))))) (QUOTE ((* THEOREMS *) (EX X I (X) AND J (X)))) (QUOTE (COMMENT (EX 10 (AND (+ 7 (10) NIL) (+ 9 (10) NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 23:10 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9879 9894 9899 9914 9919 9934 9949 9964 9969 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          "J" NIL NIL (ANY) NIL NIL ((- 9 (POSITIVE))) ((+ 9 (NEGATIVE))) ((+ 9 (NIL)))
          ((- 9 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 5 ANY NIL
