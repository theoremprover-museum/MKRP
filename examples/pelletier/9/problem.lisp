...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) (((P OR Q) AND (NOT (P) OR Q) AND (P OR NOT (Q))) IMPL NOT (NOT (P) OR NOT (Q))))) (QUOTE (COMMENT (IMPL (AND (OR (+ 2 NIL NIL) (+ 3 NIL NIL)) (AND (OR (NOT (+ 2 NIL NIL)) (+ 3 NIL NIL)) (OR (+ 2 NIL NIL) (NOT (+ 3 NIL NIL))))) (NOT (OR (NOT (+ 2 NIL NIL)) (NOT (+ 3 NIL NIL))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 21:25 ")) (PROGN(PROGN (DT-RESET))
