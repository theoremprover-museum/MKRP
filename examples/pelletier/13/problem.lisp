...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) ((P OR (Q AND R)) EQV ((P OR Q) AND (P OR R))))) (QUOTE (COMMENT (EQV (OR (+ 2 NIL (KIND (EQV T 30))) (AND (+ 3 NIL (KIND (EQV T 30))) (+ 4 NIL (KIND (EQV T 30))))) (AND (OR (+ 2 NIL (KIND (EQV NIL 30))) (+ 3 NIL (KIND (EQV NIL 30)))) (OR (+ 2 NIL (KIND (EQV NIL 30))) (+ 4 NIL (KIND (EQV NIL 30)))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 22:17 ")) (PROGN(PROGN (DT-RESET))
