...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) ((P IMPL Q) EQV (NOT (Q) IMPL NOT (P))))) (QUOTE (COMMENT (EQV (IMPL (+ 6 NIL (KIND (EQV T 30))) (+ 7 NIL (KIND (EQV T 30)))) (IMPL (NOT (+ 7 NIL (KIND (EQV NIL 30)))) (NOT (+ 6 NIL (KIND (EQV NIL 30)))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 21:08 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST
        '(9954 9969 ATP.MEMORY.NIL ATP.MEMORY.NIL ATP.MEMORY.NIL ATP.MEMORY.NIL 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ((+ 0 (NIL))) ((- 0 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 15 "FALSE" NIL NIL
          NIL (DEFINED) NIL ((- 1 (POSITIVE))) ((+ 1 (NEGATIVE))) ((+ 1 (NIL))) ((- 1 (NIL)))
          NIL NIL (DT*ST-KIND NIL) PREDICATE 15 "P" NIL NIL NIL NIL NIL ((- 6 (POSITIVE)))
          ((+ 6 (NEGATIVE))) ((+ 6 (NIL))) ((- 6 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 15
          "Q" NIL NIL NIL NIL NIL ((- 7 (POSITIVE))) ((+ 7 (NEGATIVE))) ((+ 7 (NIL)))
          ((- 7 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE))
