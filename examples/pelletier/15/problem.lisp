...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) ((P IMPL Q) EQV (NOT (P) OR Q)))) (QUOTE (COMMENT (EQV (IMPL (+ 2 NIL (KIND (EQV T 30))) (+ 3 NIL (KIND (EQV T 30)))) (OR (NOT (+ 2 NIL (KIND (EQV NIL 30)))) (+ 3 NIL (KIND (EQV NIL 30))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 22:22 ")) (PROGN(PROGN (DT-RESET))
