...
(CONSTRUCTION  "Genera 8.0.2 IP-TCP 422.9 IP-TCP-DOC 404.0 CLX 419.3 X Remote Screen 418.1 X Documentation 403.0 Network RPC 415.5 NFS Client 415.3 NFS Documentation 404.0 Logical Pathnames Translation Files NEWEST KKL 21.1 HADES 18.0 Waltz 7.0 COLUMN 8.0 MKRP 52.1 GENTRAFO 2.0" "29-DEC,1991 10:13" 
   ("Edit:     Axioms and Theorems edited: 29-DEC,1991 10:13 "
   ))

(AXIOMS.INFIX    (NIL))

(THEOREMS.INFIX (((ALL X F (A X) OR (ALL Y F (X Y))) IMPL (EX X (ALL Y F (X Y))))))

(AXIOMS.PREFIX   (NIL))

(THEOREMS.PREFIX ((IMPL (ALL 3 (OR (+ 5 (4 3) NIL) (ALL 6 (+ 5 (3 6) NIL)))) (EX 7 (ALL 8 (+ 5 (7 8) NIL))))))
...
(AXIOMS (START.TIME 56959632)
   (END.TIME 56959716)
   (FINAL 11)
   (SYMBOLS 
   (LET (NEW.ADDRESS)
   (LIST (CONS    5 (DT-PREDICATE.CREATE "F" '(ANY ANY)))
...
(THEOREMS (SPLITPART.IDENTIFIER 1)
   (START.TIME 56959758)
   (PARTIAL   (CLAUSE 11 R.= AXIOM ((9 . ANY)) ((+ 2 (9 9)) ))(CLAUSE 13 T1 THEOREM ((8 . ANY)) ((- 5 (8 (12 8))) )))
   (PARTIAL   (CLAUSE 16 T2 THEOREM ((6 . ANY)(3 . ANY))
   ((+ 5 (4 3)) (+ 5 (3 6)) )))
   (OPERATION (CLAUSE 16 T2 THEOREM ((6 . ANY)(3 . ANY))
   ((+ 5 (4 3)) (+ 5 (3 6)) ))
   (REPLACEMENT.OPERATION (3 8 6 (12 8)) (16 13)
  (((16 . 2) (13 . 1) NIL))
  (NIL)
  ((8 . ANY))))
   (OPERATION (CLAUSE 16 T2 THEOREM ((3 . ANY)) ((+ 5 (4 3)) ))
   (REPLACEMENT.OPERATION (8 4 3 (12 4)) (16 13)
  (((16 . 1) (13 . 1) NIL))
  (NIL)
  NIL))
   (END.TIME 56960717)
   ...
   (DT-PREDICATE.ADD.ATTRIBUTES NEW.ADDRESS '(DEFINED)))
   (CONS    4 (DT-CONSTANT.CREATE "a" 'ANY))
   (CONS   12 (DT-FUNCTION.CREATE "f_1" 'ANY '(ANY) 'NIL)))))
   (RESULT SUCCESS 16))
(indices ((16 1 2) (13 3) (11 NIL)))