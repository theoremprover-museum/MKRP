...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) ((NOT (P) IMPL Q) EQV (NOT (Q) IMPL P)))) (QUOTE (COMMENT (EQV (IMPL (NOT (+ 2 NIL (KIND (EQV T 30)))) (+ 3 NIL (KIND (EQV T 30)))) (IMPL (NOT (+ 3 NIL (KIND (EQV NIL 30)))) (+ 2 NIL (KIND (EQV NIL 30))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 21:17 ")) (PROGN(PROGN (DT-RESET))
