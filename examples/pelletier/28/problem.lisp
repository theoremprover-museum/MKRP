...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) ((ALL X P (X)) IMPL (ALL X Q (X))) ((ALL X Q (X) OR R (X)) IMPL (EX X Q (X) AND S (X))) ((EX X S (X)) IMPL (ALL X F (X) IMPL G (X))))) (QUOTE (COMMENT (IMPL (ALL 2 (+ 3 (2) NIL)) (ALL 4 (+ 5 (4) NIL))) (IMPL (ALL 6 (OR (+ 5 (6) NIL) (+ 7 (6) NIL))) (EX 8 (AND (+ 5 (8) NIL) (+ 9 (8) NIL)))) (IMPL (EX 10 (+ 9 (10) NIL)) (ALL 11 (IMPL (+ 12 (11) NIL) (+ 13 (11) NIL)))))) (QUOTE ((* THEOREMS *) (ALL X P (X) AND (F (X) IMPL G (X))))) (QUOTE (COMMENT (ALL 14 (AND (+ 3 (14) NIL) (IMPL (+ 12 (14) NIL) (+ 13 (14) NIL)))))) (QUOTE ("Edit:     Axioms and Theorems edited: 01-NOV,1989 20:54 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9849 9864 9879 9884 9889 9904 9909 9924 9929 9944 9949 9964 9969 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          "R" NIL NIL (ANY) NIL NIL ((- 7 (POSITIVE))) ((+ 7 (NEGATIVE))) ((+ 7 (NIL)))
          ...
          (DT*ST-KIND NIL) PREDICATE 15 "G" NIL NIL (ANY) NIL NIL ((- 13 (POSITIVE)))
