...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREMS *) (NOT (P IMPL Q) IMPL (Q IMPL P)))) (QUOTE (COMMENT (IMPL (NOT (IMPL (+ 2 NIL NIL) (+ 3 NIL NIL))) (IMPL (+ 3 NIL NIL) (+ 2 NIL NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 31-OCT,1989 21:15 ")) (PROGN(PROGN (DT-RESET))
