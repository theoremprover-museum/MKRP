...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (* GROUP *) (ALL X,Y,Z + (+ (X Y) Z) = + (X + (Y Z))) (ALL X + (0 X) = X) (ALL X + (- (X) X) = 0) (ALL X,Y + (X Y) = + (Y X)) (* * *) (ALL X,Y,Z * (* (X Y) Z) = * (X * (Y Z))) (* * GROUP CONNECTION *) (ALL X,Y,Z * (+ (X Y) Z) = + (* (X Z) * (Y Z))) (ALL X,Y,Z * (Z + (X Y)) = + (* (Z X) * (Z Y))) (* ADDITIONAL AXIOM AND THEOREM *) (ALL X * (X X) = X))) (QUOTE (COMMENT COMMENT (ALL 5 (ALL 4 (ALL 3 (+ 2 ((6 (6 3 4) 5) (6 3 (6 4 5))) NIL)))) (ALL 7 (+ 2 ((6 8 7) 7) NIL)) (ALL 9 (+ 2 ((6 (10 9) 9) 8) NIL)) (ALL 12 (ALL 11 (+ 2 ((6 11 12) (6 12 11)) NIL))) COMMENT (ALL 15 (ALL 14 (ALL 13 (+ 2 ((16 (16 13 14) 15) (16 13 (16 14 15))) NIL)))) COMMENT (ALL 19 (ALL 18 (ALL 17 (+ 2 ((16 (6 17 18) 19) (6 (16 17 19) (16 18 19))) NIL)))) (ALL 22 (ALL 21 (ALL 20 (+ 2 ((16 22 (6 20 21)) (6 (16 22 20) (16 22 21))) NIL)))) COMMENT (ALL 23 (+ 2 ((16 23 23) 23) NIL)))) (QUOTE ((ALL X,Y * (X Y) = * (Y X)))) (QUOTE ((ALL 25 (ALL 24 (+ 2 ((16 24 25) (16 25 24)) NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 12-JUL,1990 01:27 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST
        '(9817 9822 9827 9832 9837 9842 9847 9852 9857 9871 9876 9881 9886 9891 9896 9910 9915
          9920 9925 9939 9944 9949 9954 9969 9984 9999))
       (DATALIST
      ...
      (SETQ MEM*NEXT.RADR (IF (> MEM*SIZE 10000) (+ 9812 INCREMENT) 9812))
