...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* GROUP *) (ALL X,Y,Z + (+ (X Y) Z) = + (X + (Y Z))) (ALL X + (0 X) = X) (ALL X + (- (X) X) = 0) (ALL X,Y + (X Y) = + (Y X)))) (QUOTE (COMMENT (ALL 5 (ALL 4 (ALL 3 (+ 2 ((6 (6 3 4) 5) (6 3 (6 4 5))) NIL)))) (ALL 7 (+ 2 ((6 8 7) 7) NIL)) (ALL 9 (+ 2 ((6 (10 9) 9) 8) NIL)) (ALL 12 (ALL 11 (+ 2 ((6 11 12) (6 12 11)) NIL))))) (QUOTE ((* THEOREM *) (ALL X,Y + (- (X) - (Y)) = - (+ (X Y))))) (QUOTE (COMMENT (ALL 14 (ALL 13 (+ 2 ((6 (10 13) (10 14)) (10 (6 13 14))) NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 13-JUL,1990 01:34 ")) (PROGN(PROGN (DT-RESET))
