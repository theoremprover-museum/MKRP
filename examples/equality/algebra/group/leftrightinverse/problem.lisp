...
(PREP-PROBLEM.SPECIFICATION '((ALL X,Y,Z PLUS (PLUS (X Y) Z) = PLUS (X PLUS (Y Z))) (ALL X PLUS (0 X) = X)
  (ALL X PLUS (MINUS (X) X) = 0)) '((ALL 4 (ALL 3 (ALL 2 (+ 6 ((5 (5 2 3) 4) (5 2 (5 3 4))) NIL)))) (ALL 7 (+ 6 ((5 8 7) 7) NIL))
  (ALL 9 (+ 6 ((5 (10 9) 9) 8) NIL))) '((ALL X PLUS (X MINUS (X)) = 0)) '((ALL 11 (+ 6 ((5 11 (10 11)) 8) NIL))) '("                                                                                                                     "
  "*********************************************************************************************************************"
  " EDIT:     Axioms and Theorems edited: 04-JUL,1989 22:34 "
  "*********************************************************************************************************************"
  ) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9896 9910 9915 9920 9925 9940 9954 9959 9964 9969 9984 9999))
       (DATALIST
