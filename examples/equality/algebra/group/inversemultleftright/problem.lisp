...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((ALL X,Y,Z PLUS (PLUS (X Y) Z) = PLUS (X PLUS (Y Z))) (ALL X PLUS (0 X) = X) (ALL X PLUS (X 0) = X) (ALL X PLUS (MINUS (X) X) = 0) (ALL X PLUS (X MINUS (X)) = 0))) (QUOTE ((ALL 5 (ALL 4 (ALL 3 (+ 2 ((6 (6 3 4) 5) (6 3 (6 4 5))) NIL)))) (ALL 7 (+ 2 ((6 8 7) 7) NIL)) (ALL 9 (+ 2 ((6 9 8) 9) NIL)) (ALL 10 (+ 2 ((6 (11 10) 10) 8) NIL)) (ALL 12 (+ 2 ((6 12 (11 12)) 8) NIL)))) (QUOTE ((ALL X,Y PLUS (MINUS (X) MINUS (Y)) = MINUS (PLUS (Y X))))) (QUOTE ((ALL 14 (ALL 13 (+ 2 ((6 (11 13) (11 14)) (11 (6 14 13))) NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 06-JUL,1990 17:16 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9881 9886 9891 9905 9910 9915 9920 9925 9939 9944 9949 9954 9969 9984 9999))
       (DATALIST
      ...
      (SETQ MEM*NEXT.RADR (IF (> MEM*SIZE 10000) (+ 9876 INCREMENT) 9876))
