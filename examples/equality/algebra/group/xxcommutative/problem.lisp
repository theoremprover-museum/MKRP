...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (* GROUP *) (ALL X,Y,Z + (+ (X Y) Z) = + (X + (Y Z))) (ALL X + (0 X) = X) (ALL X + (- (X) X) = 0) (* NIL POTENT *) (ALL X + (X X) = 0))) (QUOTE (COMMENT COMMENT (ALL 5 (ALL 4 (ALL 3 (+ 2 ((6 (6 3 4) 5) (6 3 (6 4 5))) NIL)))) (ALL 7 (+ 2 ((6 8 7) 7) NIL)) (ALL 9 (+ 2 ((6 (10 9) 9) 8) NIL)) COMMENT (ALL 11 (+ 2 ((6 11 11) 8) NIL)))) (QUOTE ((* THEOREM *) (ALL X,Y + (X Y) = + (Y X)))) (QUOTE (COMMENT (ALL 13 (ALL 12 (+ 2 ((6 12 13) (6 13 12)) NIL))))) (QUOTE ("Edit:     Axioms and Theorems edited: 21-NOV,1990 02:46 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9886 9891 9896 9910 9915 9920 9925 9939 9944 9949 9954 9969 9984 9999))
       (DATALIST
