...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (* GROUP *) (ALL X,Y,Z + (+ (X Y) Z) = + (X + (Y Z))) (ALL X + (0 X) = X) (ALL X + (- (X) X) = 0) (ALL X + (X - (X)) = 0))) (QUOTE (COMMENT COMMENT (ALL 5 (ALL 4 (ALL 3 (+ 2 ((6 (6 3 4) 5) (6 3 (6 4 5))) NIL)))) (ALL 7 (+ 2 ((6 8 7) 7) NIL)) (ALL 9 (+ 2 ((6 (10 9) 9) 8) NIL)) (ALL 11 (+ 2 ((6 11 (10 11)) 8) NIL)))) (QUOTE ((* THEOREM *) (ALL X + (X 0) = X))) (QUOTE (COMMENT (ALL 12 (+ 2 ((6 12 8) 12) NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 09-AUG,1990 19:34 ")) (PROGN(PROGN (DT-RESET))
