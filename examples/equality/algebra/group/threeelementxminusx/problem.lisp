...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOMS *) (ALL X,Y,Z + (+ (X Y) Z) = + (X + (Y Z))) (ALL X + (0 X) = X) (ALL X + (- (X) X) = 0))) (QUOTE (COMMENT (ALL 5 (ALL 4 (ALL 3 (+ 2 ((6 (6 3 4) 5) (6 3 (6 4 5))) NIL)))) (ALL 7 (+ 2 ((6 8 7) 7) NIL)) (ALL 9 (+ 2 ((6 (10 9) 9) 8) NIL)))) (QUOTE ((* THEOREM *) ((ALL X,Y,Z X = Y OR Z = Y OR X = Z) IMPL (ALL U - (U) = U)))) (QUOTE (COMMENT (IMPL (ALL 13 (ALL 12 (ALL 11 (OR (+ 2 (11 12) NIL) (OR (+ 2 (13 12) NIL) (+ 2 (11 13) NIL)))))) (ALL 14 (+ 2 ((10 14) 14) NIL))))) (QUOTE ("                                                                                                                     " "*********************************************************************************************************************" "                                                                                                                     " " FORMULA:  Date: 19-NOV,1991 11:44" "           Axioms und Theorems for this proof have been read from" "              Axiom-File: NIL" "            Theorem-File: NIL" "                                                                                                                     " "*********************************************************************************************************************")) (PROGN(PROGN (DT-RESET))
...
(PROG ((ADDRLIST
      ...
      (SETQ MEM*NEXT.RADR (IF (> MEM*SIZE 20000) (+ 19876 INCREMENT) 19876))
