...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((* AXIOM *) (F (G (A)) = A))) (QUOTE (COMMENT (+ 2 ((5 (4 3)) 3) NIL))) (QUOTE ((* THEOREM *) (EX X G (F (X)) = X))) (QUOTE (COMMENT (EX 6 (+ 2 ((4 (5 6)) 6) NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 09-MAY,1990 21:28 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9921 9935 9949 9954 9969 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          NIL NIL (DT*ST-KIND NIL) PREDICATE 5 ANY "A" (DT*ST-KIND NIL) CONSTANT 14 "G" NIL
          ANY (ANY) NIL NIL NIL NIL NIL 1 ANY (DT*ST-KIND NIL) FUNCTION 14 "F" NIL ANY (ANY)
