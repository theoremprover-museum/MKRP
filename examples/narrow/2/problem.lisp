...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((ALL X * (X X) = X))) (QUOTE ((ALL 3 (+ 2 ((4 3 3) 3) NIL)))) (QUOTE ((EX T,U,V,W,X,Y,Z * (* (X Y) * (* (* (A B) C) Z)) = * (* (U * (V W)) * (T * (A B)))))) (QUOTE ((EX 11 (EX 10 (EX 9 (EX 8 (EX 7 (EX 6 (EX 5 (+ 2 ((4 (4 9 10) (4 (4 (4 12 13) 14) 11)) (4 (4 6 (4 7 8)) (4 5 (4 12 13)))) NIL)))))))))) (QUOTE ("Edit:     Axioms and Theorems edited: 07-MAR,1991 18:50 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9890 9895 9900 9905 9910 9915 9920 9925 9930 9935 9949 9954 9969 9984 9999))
       (DATALIST
