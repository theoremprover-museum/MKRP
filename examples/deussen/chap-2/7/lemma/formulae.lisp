...
(SORT MENGE,VERKN,ABB : ANY)
(TYPE W(MENGE) :MENGE)
(* LEMMA 2.7.LR *)
(ALL F:MENGE ALL MAL:VERKN HG(F MAL) IMPL(FREI(F MAL) IMPL(EX X:MENGE EX PHI:ABB ISOMORPH(PHI F W(X)))))
(* LEMMA 2.7.RL *)
(ALL F:MENGE ALL MAL:VERKN HG(F MAL) IMPL((EX X:MENGE EX PHI:ABB ISOMORPH(PHI F W(X))) IMPL FREI(F MAL)))

(ALL F:MENGE ALL MAL:VERKN HG(F MAL) IMPL(FREI(F MAL) EQV(EX X:MENGE EX PHI:ABB ISOMORPH(PHI F W(X)))))
