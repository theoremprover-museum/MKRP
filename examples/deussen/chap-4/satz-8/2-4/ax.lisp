...
(COND ((FMT-LOAD "17-NOV-1987 19:01"
  (((TYPE UNION2 (REL REL) :REL) NIL NIL) ((SORT REL:SET) NIL NIL)
 ((SORT EL.OF.S:ELEMENT) NIL NIL)
 ((* ************************************************************************) NIL NIL)
 ((* DEFINITIONEN VON RELATIONEN AUF EINER FESTEN MENGE S) NIL NIL) ((TYPE S:SET) NIL NIL)
 ((* DEFINITION 2.3: IDENTISCHE RELATION) NIL NIL) ((TYPE IDENTITY:REL) NIL NIL)
 ((* DEFINITION 2.4: KONVERSE RELATION) NIL NIL) ((TYPE CONVERSE (REL) :REL) NIL NIL)
 ((* SORTENPROBLEM) NIL NIL) ((* DEFINITION 2.8: AEQUIVALENZRELATION) NIL NIL)
 ((SORT EQU.RELATION:REL) NIL NIL)
 ((* DEFINITION 2.10: REFLEXIV-SYMMETRISCHER ABSCHLUSS) NIL NIL)
 ((TYPE REF.SYM.CLOS (REL) :REL) NIL NIL) ((* DEFINITION 2.11:TRANSITIVER ABSCHLUSS) NIL NIL)
 ((TYPE TRANS.CLOS (REL) :REL) NIL NIL)
 ((* DEFINITION 2.12: ERZEUGTE AEQUIVALENZRELATION) NIL NIL)
 ((TYPE GEN.EQU.REL (REL) :REL) NIL NIL)
 ((ALL RHO:REL GEN.EQU.REL (RHO) = TRANS.CLOS (REF.SYM.CLOS (RHO))) NIL NIL)
 ((* DEFINITION DER TRANSITIVEN VEREINIGUNG) NIL NIL)
 ((ALL RHO,SIGMA:REL TRANS.UNION (RHO SIGMA) = TRANS.CLOS (UNION2 (RHO SIGMA))) NIL NIL)
 ((* SATZ4-8>2-3) NIL NIL)
 ((ALL RHO,SIGMA:EQU.RELATION UNION2 (RHO SIGMA) = REF.SYM.CLOS (UNION2 (RHO SIGMA))) NIL NIL))
  (((* ************************************************) COMMENT COMMENT)
 ...
 ((* DEFINITION 2.11:TRANSITIVER ABSCHLUSS) COMMENT COMMENT)
 ((TYPE TRANS.CLOS (REL) :REL) (+ 0 NIL) TYPE)
 ((* DEFINITION 2.12: ERZEUGTE AEQUIVALENZRELATION) COMMENT COMMENT)
 ((TYPE GEN.EQU.REL (REL) :REL) (+ 0 NIL) TYPE)
 ((ALL RHO:REL GEN.EQU.REL (RHO) = TRANS.CLOS (REF.SYM.CLOS (RHO)))
  (ALL 12 (+ 13 ((11 12) (10 (9 12))) NIL)) QUANTIFICATION)
 ((* DEFINITION DER TRANSITIVEN VEREINIGUNG) COMMENT COMMENT)
 ((ALL RHO,SIGMA:REL TRANS.UNION (RHO SIGMA) = TRANS.CLOS (UNIONZWEI (RHO SIGMA)))
  (ALL 15 (ALL 14 (+ 13 ((16 14 15) (10 (5 14 15))) NIL))) QUANTIFICATION)
 ((* SATZ4-8>2-3) COMMENT COMMENT)
 ((ALL RHO,SIGMA:EQU.RELATION UNIONZWEI (RHO SIGMA) = REF.SYM.CLOS (UNIONZWEI (RHO SIGMA)))
  (ALL 18 (ALL 17 (+ 13 ((5 17 18) (9 (5 17 18))) NIL))) QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))

(PROG ((ADDRLIST
        '(119797 119802 119816 119821 119826 119841 119846 119860 119874 119888 119902 119907
          119912 119926 119940 119954 119969 119984 119999))
       (DATALIST
      ...
      (COND ((> MEM*SIZE 120000) (SETQ MEM*NEXT.RADR (+ 119792 INCREMENT)))
            (T (SETQ MEM*NEXT.RADR 119792)))
...
(PROGN (PROGN (SETF (GET 'EQU.RELATION 'DT*SORT.NUMBER) '6)
       ...
       (SETQ ST*SYMBOL.ADDRESSES
              '(NIL (ANY . T) (TRUE . 0) (FALSE . 1) (SET . T) (ELEMENT . T) (EL . 2)
                ...
                (X_15 . 15) (TRANS.UNION . 16) (X_17 . 17) (X_18 . 18))))))))