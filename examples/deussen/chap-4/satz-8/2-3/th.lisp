...
(COND ((FMT-LOAD "17-NOV-1987 17:10"
  NIL
  (((ALL RHO,SIGMA:EQU.RELATION UNIONZWEI (RHO SIGMA) = REF.SYM.CLOS (UNIONZWEI (RHO SIGMA)))
  (ALL 30 (ALL 29 (+ 20 ((5 29 30) (21 (5 29 30))) NIL))) QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))

(PROG ((ADDRLIST
        '(119754 119759 119764 119769 119774 119779 119784 119789 119794 119808 119823 119828
          119833 119838 119843 119848 119853 119868 119882 119887 119892 119897 119902 119907
      ...
      (COND ((> MEM*SIZE 120000) (SETQ MEM*NEXT.RADR (+ 119749 INCREMENT)))
            (T (SETQ MEM*NEXT.RADR 119749)))
      (SETQ MEM*NEXT.VADR 31)
