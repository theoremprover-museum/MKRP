...
(COND ((FMT-LOAD "24-NOV-1987 00:12"
  NIL
  (((* ************************************************) COMMENT COMMENT)
 ...
 ((* DEFINITION 1.1: TEILMENGE) COMMENT COMMENT) ((TYPE SUBSET (SET SET)) (+ 0 NIL) TYPE)
 ((ALL X,Y:SET SUBSET (X Y) EQV (ALL A:ELEMENT EL (A X) IMPL EL (A Y)))
  (ALL 5
   (ALL 4
    (EQV (+ 3 (4 5) (KIND (EQV T 90)))
     (ALL 6 (IMPL (+ 2 (6 4) (KIND (EQV NIL 90))) (+ 2 (6 5) (KIND (EQV NIL 90))))))))
  QUANTIFICATION)
 ...
 ((ALL F:SYMB.OF.FUNCTION ALL X,Y:SET MAPPING (F X Y) EQV
  ...
  (ALL 11
   (ALL 13
    (ALL 12
     (EQV (+ 9 (11 12 13) (KIND (EQV T 170)))
      (ALL 14
       (IMPL (+ 2 (14 12) (KIND (EQV NIL 170))) (+ 2 ((10 11 14) 13) (KIND (EQV NIL 170))))))))
   )
  QUANTIFICATION)
 ((* SORTENPROBLEM!!!!!!!) COMMENT COMMENT)
 ((TYPE MAPPING.S (SYMB.OF.FUNCTION SET SET)) (+ 0 NIL) TYPE) ((TYPE S:SET) (+ 0 NIL) TYPE)
 ((SORT EL.OF.S:ELEMENT) (+ 0 NIL) TYPE)
 ((ALL F:SYMB.OF.FUNCTION ALL Y:SET MAPPING.S (F S Y) EQV (ALL A:EL.OF.S EL (APPLY (F A) Y)))
  (ALL 17
   (ALL 18
    (EQV (+ 15 (17 16 18) (KIND (EQV T 220)))
     (ALL 19 (+ 2 ((10 17 19) 18) (KIND (EQV NIL 220)))))))
  QUANTIFICATION)
 ((* ************************************************************************) COMMENT COMMENT)
 ((* DEFINITIONEN VON RELATIONEN AUF EINER FESTEN MENGE S) COMMENT COMMENT)
 ((SORT REL:SET) (+ 0 NIL) TYPE) ((* DEFINITION 2.8: AEQUIVALENZRELATION) COMMENT COMMENT)
 ...
 ((ALL PHI:SYMB.OF.FUNCTION
   (ALL U:SET MAPPING.S (PHI S U) IMPL
    (ALL A:ELEMENT EL (A IND.EQU (PHI U)) EQV
     (EX B,C:EL.OF.S A = PAIR (B C) AND APPLY (PHI B) = APPLY (PHI C)))))
  (ALL 22
   (ALL 21
    (IMPL (+ 15 (22 16 21) NIL)
     (ALL 23
      (EQV (+ 2 (23 (20 22 21)) (KIND (EQV T 300)))
       (EX 25
        (EX 24
         (AND (+ 26 (23 (8 24 25)) (KIND (EQV NIL 300)))
              (+ 26 ((10 22 24) (10 22 25)) (KIND (EQV NIL 300)))))))))))
  QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))

(PROG ((ADDRLIST
        '(219773 219778 219783 219788 219798 219793 219812 219817 219822 219827 219832 219847
          219852 219857 219862 219867 219881 219896 219910 219924 219929 219934 219939 219954
      ...
      (COND ((> MEM*SIZE 220000) (SETQ MEM*NEXT.RADR (+ 219758 INCREMENT)))
            (T (SETQ MEM*NEXT.RADR 219758)))
...
(PROGN (PROGN (SETF (GET 'EQU.RELATION 'DT*DIRECT.SUBSORTS) 'NIL)
       ...
       (SETQ ST*SYMBOL.ADDRESSES
              '(NIL (ANY . T) (TRUE . 0) (FALSE . 1) (SET . T) (ELEMENT . T) (EL . 2)
                ...
                (X_21 . 21) (X_23 . 23) (X_24 . 24) (X_25 . 25) (= . 26))))))))