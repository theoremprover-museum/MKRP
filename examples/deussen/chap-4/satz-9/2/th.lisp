...
(COND ((FMT-LOAD "17-NOV-1987 19:32"
  NIL
  (((ALL PHI:SYMB.OF.FUNCTION ALL U:SET NOT MAPPING (PHI S U) IMPL EQU.REL (IND.EQU (PHI U)))
  (ALL 36 (ALL 37 (IMPL (NOT (+ 8 (36 5 37) NIL)) (+ 26 ((28 36 37)) NIL)))) QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))
...
(PROGN (PROGN (SETF (GET 'EQU.RELATION 'DT*SORT.NUMBER) '7)
       ...
       (PROGN (SETF (GET 'SYMB.OF.FUNCTION 'DT*DIRECT.SUBSORTS) 'NIL)
              (SETF (GET 'SYMB.OF.FUNCTION 'DT*SORT.NUMBER) '5)
