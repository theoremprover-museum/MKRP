...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((E (A S) OR E (A T)) (P (A)) (ALL X : S NOT P (X)) (R (A)))) (QUOTE ((OR (+ 4 (5 6) NIL) (+ 4 (5 7) NIL)) (+ 8 (5) NIL) (ALL 9 (NOT (+ 8 (9) NIL))) (+ 10 (5) NIL))) (QUOTE ((EX Y : T R (Y)))) (QUOTE ((EX 11 (+ 10 (11) NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 03-NOV,1992 13:24 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9884 9899 9904 9919 9924 9929 9934 9949 9954 9969 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          5 ANY "S" (DT*ST-KIND NIL) CONSTANT 5 ANY "T" (DT*ST-KIND NIL) CONSTANT 15 "P" NIL
          NIL (ANY) NIL NIL ((- 8 (POSITIVE))) ((+ 8 (NEGATIVE))) ((+ 8 (NIL))) ((- 8 (NIL)))
          NIL NIL (DT*ST-KIND NIL) PREDICATE 5 6 NIL (ST*DATA NIL DT*ST-KIND SYS-VAR) VARIABLE
          15 "R" NIL NIL (ANY) NIL NIL ((- 10 (POSITIVE))) ((+ 10 (NEGATIVE))) ((+ 10 (NIL)))
          ((- 10 (NIL))) NIL NIL (DT*ST-KIND NIL) PREDICATE 5 7 NIL
