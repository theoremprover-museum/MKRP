...
(AXIOMS (START.TIME 3555624082)
   (PARTIAL   (CLAUSE 14 R.= AXIOM ((12 . 3)) ((+ 2 (12 12)) ))(CLAUSE 15 A1 AXIOM () ((+ 8 (5)) )))
   (PARTIAL   (CLAUSE 17 A2 AXIOM ((9 . 6)) ((- 8 (9)) )))
   (PARTIAL   (CLAUSE 18 A3 AXIOM () ((+ 10 (5)) )))
   (PARTIAL   (CLAUSE 19 A4 AXIOM ()
   ((+ 4 (5 6)) (+ 4 (5 7)) )))
   (END.TIME 3555626448)
   (FINAL 14 15 17 18 19)
   (SYMBOLS 
   (LET (NEW.ADDRESS)
   (LIST (CONS   10 (DT-PREDICATE.CREATE "R" '(ANY)))
   (CONS    8 (DT-PREDICATE.CREATE "P" '(ANY)))
   ...
   (DT-PREDICATE.ADD.ATTRIBUTES NEW.ADDRESS '(DEFINED)))
   (CONS    7 (DT-CONSTANT.CREATE "t" 'ANY))
   (CONS    6 (DT-CONSTANT.CREATE "s" 'ANY))
   (CONS    5 (DT-CONSTANT.CREATE "a" 'ANY))
   (CONS    3 (DT-CONSTANT.CREATE "omega" 'ANY)))))
   (RESULT))

(THEOREMS (SPLITPART.IDENTIFIER 1)
   (START.TIME 3555626575)
   (PARTIAL   (CLAUSE 21 T5 THEOREM ((11 . 7)) ((- 10 (11)) )))
   (INITIAL   (CLAUSE 14 R.= AXIOM ((12 . 3)) ((+ 2 (12 12)) ))
(CLAUSE 15 A1 AXIOM () ((+ 8 (5)) ))
(CLAUSE 17 A2 AXIOM ((9 . 6)) ((- 8 (9)) ))
(CLAUSE 18 A3 AXIOM () ((+ 10 (5)) ))
(CLAUSE 19 A4 AXIOM ()
   ((+ 4 (5 6)) (+ 4 (5 7)) ))
(CLAUSE 21 T5 THEOREM ((11 . 7)) ((- 10 (11)) ))   )
   (END.TIME 3555631454)
   (FINAL 14 15 17 18 19 21)
   (SYMBOLS 
   (LET (NEW.ADDRESS)
   (LIST (CONS   10 (DT-PREDICATE.CREATE "R" '(ANY)))
   (CONS    8 (DT-PREDICATE.CREATE "P" '(ANY)))
...
(REFUTATION (START.TIME 3555633552)
...
(CLAUSE 19 A4 AXIOM ()
   ((+ 4 (5 6)) (+ 4 (5 7)) ))
(CLAUSE 21 T5 THEOREM ((11 . 7)) ((- 10 (11)) ))   )
   (OPERATION (CLAUSE 25 R1 (21 18) () ())
   (RESOLUTION 18 1 21 1 NIL (11 5) 25))
   (END.TIME 3555636603)
   (SYMBOLS 
   (LET (NEW.ADDRESS)
   (LIST (CONS   10 (DT-PREDICATE.CREATE "R" '(ANY)))
