...
(PREP-PROBLEM.SPECIFICATION (QUOTE ((E (A SHIT) OR E (A BULLSHIT)) (ALL X : SHIT P (X)) (ALL X : BULLSHIT P (X)) (ALL X : SHIT NOT P (X)))) (QUOTE ((OR (+ 4 (5 6) NIL) (+ 4 (5 7) NIL)) (ALL 8 (+ 9 (8) NIL)) (ALL 10 (+ 9 (10) NIL)) (ALL 11 (NOT (+ 9 (11) NIL))))) (QUOTE ((EX X : BULLSHIT P (X)))) (QUOTE ((EX 12 (+ 9 (12) NIL)))) (QUOTE ("Edit:     Axioms and Theorems edited: 26-FEB,1992 14:38 ")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(9889 9894 9899 9914 9919 9924 9929 9934 9949 9954 9969 9984 9999))
       (DATALIST
        '(15 "TRUE" NIL NIL NIL (DEFINED) NIL ((- 0 (POSITIVE))) ((+ 0 (NEGATIVE)))
          ...
          (ST*DATA NIL DT*ST-KIND SYS-VAR) VARIABLE 5 7 NIL (ST*DATA NIL DT*ST-KIND SYS-VAR)
          VARIABLE))
