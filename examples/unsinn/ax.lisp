...
(COND ((FMT-LOAD "13-NOV-1987 21:43"
  NIL
  (((SORT SET :ANY) (+ 0 NIL) TYPE) ((SORT ELEMENT :ANY) (+ 0 NIL) TYPE)
 ((TYPE INTERSECTION (SET SET) :SET) (+ 0 NIL) TYPE)
 ((TYPE MEMBER (ELEMENT SET)) (+ 0 NIL) TYPE) ((TYPE SETEQUAL (SET SET)) (+ 0 NIL) TYPE)
 ((ALL A,B :SET SETEQUAL (A B) EQV (ALL X:ELEMENT MEMBER (X A) EQV MEMBER (X B)))
  (ALL 6
   (ALL 5
    (EQV (+ 4 (5 6) (KIND (EQV T 71)))
     (ALL 7
      (EQV (+ 3 (7 5) (KIND (EQV T 70 EQV NIL 71))) (+ 3 (7 6) (KIND (EQV NIL 70 EQV NIL 71))))
      ))))
  QUANTIFICATION)
 ((ALL A,B :SET ALL X:ELEMENT MEMBER (X INTERSECTION (A B)) EQV (MEMBER (X A) AND MEMBER (X B))
  ...
  (ALL 9
   (ALL 8
    (ALL 10
     (EQV (+ 3 (10 (2 8 9)) (KIND (EQV T 80)))
      (AND (+ 3 (10 8) (KIND (EQV NIL 80)))
           (+ 3 (10 9) (KIND (EQV NIL 80))))))))
  QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))

(PROG ((ADDRLIST '(19900 19905 19910 19915 19920 19925 19940 19955 19969 19984 19999))
       (DATALIST
      ...
      (COND ((> MEM*SIZE 20000)
            ...
            (T (UNLESS (= MEM*SIZE 20000)
               ...
               (MAPC #'(LAMBDA (DATA)
                         (SETF (AREF MEM*MEMORY (SETQ COUNTER1 (1- COUNTER1))) DATA))
                     DATALIST)))
      (COND ((> MEM*SIZE 20000) (SETQ MEM*NEXT.RADR (+ 19895 INCREMENT)))
            (T (SETQ MEM*NEXT.RADR 19895)))
