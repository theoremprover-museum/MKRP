(COND ((FMT-LOAD " 6-SEP-84 19:57:55" NIL (((GROUP (A) AND GROUP (B) AND SUBSET (A B) IMPL ID (A) = ID (B)) (IMPL
(AND (+ 5 (16) NIL) (AND (+ 5 (17) NIL) (+ 3 (16 17) NIL))) (+ 14 ((6 16) (6 17)) NIL)) QUANTIFICATION))) (COND
...
DT*TRANSITIVE.CLOSURE (ELEMENT SET ANY) DT*DIRECT.SUBSORTS (ELEMENT SET)))))) (RPAQQ ST*STACK1 (NIL NIL NIL)) (RPAQQ
ST*SYMBOL.ADDRESSES (NIL (ANY . T) (TRUE . 1) (FALSE . 2) (SET . T) (SUBSET . 3) (ELEMENT . T) (MEMBER . 4) (GROUP
. 5) (ID . 6) (X_7 . 7) (X_8 . 8) (X_9 . 9) (* . 10) (- . 11) (X_12 . 12) (X_13 . 13) (= . 14) (X_15 . 15) (A .
16) (B . 17))))))))STOP
