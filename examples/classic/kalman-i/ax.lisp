...
(COND ((FMT-LOAD "25-NOV-1987 20:45"
  NIL
 ...
 ((ALL X,Y,Z P (F (X F (F (Y F (Z X)) F (Z Y)))))
  (ALL 8 (ALL 7 (ALL 6 (+ 4 ((5 6 (5 (5 7 (5 8 6)) (5 8 7)))) NIL)))) QUANTIFICATION)
 ((ALL X P (F (X X))) (ALL 9 (+ 4 ((5 9 9)) NIL)) QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))

(PROG ((ADDRLIST '(219915 219920 219925 219930 219944 219959 219964 219969 219984 219999))
       (DATALIST
      ...
      (COND ((> MEM*SIZE 220000) (SETQ MEM*NEXT.RADR (+ 219910 INCREMENT)))
            (T (SETQ MEM*NEXT.RADR 219910)))
