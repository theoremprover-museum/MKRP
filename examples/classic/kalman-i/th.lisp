...
(COND ((FMT-LOAD "25-NOV-1987 20:45"
  ...
  (ALL 10 (ALL 11 (ALL 12 (+ 4 ((5 (5 (5 12 (5 11 10)) 10) (5 11 12))) NIL)))) QUANTIFICATION)))(COND (ST*LOAD.FLAG (PROGN (DT-RESET))

(PROG ((ADDRLIST
        '(219910 219905 219900 219915 219920 219925 219930 219944 219959 219964 219969 219984
          219999))
       (DATALIST
...
(PROGN (PROGN (SETF (GET 'ANY 'DT*SORT.NUMBER) '1)
       ...
       (SETQ ST*SYMBOL.ADDRESSES
              '(NIL (ANY . T) (TRUE . 0) (FALSE . 1) (X_2 . 2) (X_3 . 3) (P . 4) (F . 5)
                (X_6 . 6) (X_7 . 7) (X_8 . 8) (X_9 . 9) (X_12 . 12) (X_11 . 11) (X_10 . 10))))))))