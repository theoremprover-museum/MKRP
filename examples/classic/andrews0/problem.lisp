...
(PREP-PROBLEM.SPECIFICATION (QUOTE NIL) (QUOTE NIL) (QUOTE ((* THEOREM *) ((EX X ALL Y P (X) EQV P (Y)) EQV ((EX X P (X)) EQV (ALL Y P (Y)))))) (QUOTE (COMMENT (EQV (EX 3 (ALL 4 (EQV (+ 5 (3) (KIND (EQV T 20 EQV T 22))) (+ 5 (4) (KIND (EQV NIL 20 EQV T 22)))))) (EQV (EX 6 (+ 5 (6) (KIND (EQV T 21 EQV NIL 22)))) (ALL 7 (+ 5 (7) (KIND (EQV NIL 21 EQV NIL 22)))))))) (QUOTE ("                                                                                                                     " "*********************************************************************************************************************" "                                                                                                                     " " FORMULA:  Date: 07-NOV,1991 16:42" "           Axioms und Theorems for this proof have been read from" "              Axiom-File: NIL" "            Theorem-File: NIL" "                                                                                                                     " "*********************************************************************************************************************")) (PROGN(PROGN (DT-RESET))

(PROG ((ADDRLIST '(159924 159929 159944 159949 159954 159969 159984 159999))
       (DATALIST
      ...
      (SETQ MEM*NEXT.RADR (IF (> MEM*SIZE 160000) (+ 159919 INCREMENT) 159919))
