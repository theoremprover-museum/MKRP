...
#+(or omega1 omega)(push :mkrp-basic *features*)
#-(or omega1 omega)(setq *features* (delete :mkrp-basic *features*))
...
#+CLTL2(declaim (declaration edited authors input effect value remark))
#-CLTL2(proclaim '(declaration edited authors input effect value remark))
